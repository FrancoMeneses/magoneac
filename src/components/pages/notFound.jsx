...
export function NotFound() {
  return(
    <main className="flex flex-col items-center w-full h-full my-12 px-4">
      ...
      <img className="lg:w-[900px] drop-shadow-md" src="https://res.cloudinary.com/dfnqqumsc/image/upload/v1675121332/Portfolio/magoneEscuela/404_Error-pana_lwnrqz.svg" alt="Pagina no encontrada" />
